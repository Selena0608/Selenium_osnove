...
//		Morate da dohvatite uvek Add dugme iz poslednjeg reda 
//		tabele. Mozete koristeci index iz petlje, a mozete 
...
//		Na kraju programa ugasite pretrazivac.
		...
		for (int i = 0; i < 5; i++) {
			...
			driver.findElement(By.name("name")).sendKeys("Selena");
			driver.findElement(By.name("department")).sendKeys("Radovanovic");
			driver.findElement(By.name("phone")).sendKeys("06476806776");
			driver.findElement(By.xpath("//table[contains(@class, 'table table-bordered')]//tr[last()]/td[last()]/a[1]"))
			.click();
